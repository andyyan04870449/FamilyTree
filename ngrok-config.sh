...
# 固定網址設定（付費版功能）
export FRONTEND_SUBDOMAIN="familytree-frontend"  # 前端固定網址：https://familytree-frontend.jp.ngrok.io
export BACKEND_SUBDOMAIN="familytree-backend"    # 後端固定網址：https://familytree-backend.jp.ngrok.io
